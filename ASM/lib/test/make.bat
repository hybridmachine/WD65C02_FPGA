...
WDC02AS -I../../common -G -L -DUSING_02 ..\..\drivers\i2c_streamer\I2CStreamer.asm -o I2CStreamer.obj
WDC02AS -I../../common -g -l -DUSING_02 ..\..\POST\MemTest\MemTest.asm -O MemTest.obj
WDC02AS -I../../common -g -l -DUSING_02 ..\..\drivers\seven_segment_display\SevenSegmentDisplay.asm -O SevenSegmentDisplay.obj
...
WDCLN -CFA00 -HI TestI2CLogger I2CLogger.obj I2CStreamer.obj MemTest.obj SevenSegmentDisplay.obj -O .\TestI2CStreamer.hex
python ..\..\HexToVHDLTools\ConvertHexToVHD_ROM.py --hex_file .\TestI2CStreamer.hex --vhd_template "..\..\..\WD6502 Computer.srcs\sources_1\new\ROM.vhd" --start_address 0xFA00 --end_address 0xFFFF --output_vhd ROM.vhd
REM Deploy ROM
copy .\ROM.vhd '..\..\..\WD6502 Computer.srcs\sources_1\new\ROM.vhd'
REM
REM Build for the simulator. 
WDCLN -CFA00 -G -SZ -T -V -HZ TestI2CLogger MemTest.obj I2CLogger.obj I2CStreamer.obj SevenSegmentDisplay.obj
