...
WDCLN -CFC00 -HI TestI2CLogger I2CLogger.obj I2CStreamer.obj MemTest.obj SevenSegmentDisplay.obj -O .\TestI2CStreamer.hex
...
WDCLN -CFC00 -G -SZ -T -V -HZ TestI2CLogger MemTest.obj I2CLogger.obj I2CStreamer.obj SevenSegmentDisplay.obj
