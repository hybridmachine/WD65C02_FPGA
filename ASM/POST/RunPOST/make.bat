...
WDC02AS -G -L -DUSING_02 RunPOST.asm
WDC02AS -G -L -DUSING_02 ..\MemTest\MemTest.asm -O MemTest.obj
...
WDCLN -CFC00 -HI RunPOST MemTest.obj SevenSegmentDisplay.obj -O .\RunPOST.hex
python ..\..\HexToVHDLTools\ConvertHexToVHD_ROM.py --hex_file .\RunPOST.hex --vhd_template "..\..\..\WD6502 Computer.srcs\sources_1\new\ROM.vhd" --start_address 0xFC00 --end_address 0xFFF9 --output_vhd ROM.vhd

REM Build for the simulator. 
WDCLN -CFC00 -G -SZ -T -V -HZ RunPOST MemTest.obj SevenSegmentDisplay.obj
