...
WDCLN -CFC00 -HI TestI2CStreamer I2CStreamer.obj SevenSegmentDisplay.obj -O .\TestI2CStreamer.hex
...
WDCLN -CFC00 -G -SZ -T -V -HZ TestI2CStreamer I2CStreamer.obj SevenSegmentDisplay.obj
