...
WDCLN -CFC00 -G -SZ -T -V -HZ -HZ GameOfLife Multiply.obj Divide.obj GameBoardV2.obj
@REM WDCLN -HI .\GameOfLife.obj -O .\GameOfLife.hex
WDCLN -CFC00 -HI GameOfLife Multiply.obj Divide.obj GameBoardV2.obj -O .\GameOfLife.hex
