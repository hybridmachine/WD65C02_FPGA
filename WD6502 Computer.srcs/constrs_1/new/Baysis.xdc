...
create_clock -period 500 [get_ports PHI2]
...
set_input_delay -clock [get_clocks PHI2] -max 20 [get_ports ADDRESS_IN]
set_input_delay -clock [get_clocks PHI2] -min 10 [get_ports ADDRESS_IN]

set_input_delay -clock [get_clocks PHI2] -max 20 [get_ports DATA]
set_input_delay -clock [get_clocks PHI2] -min 10 [get_ports DATA]

set_output_delay -clock [get_clocks PHI2] -max 20 [get_ports DATA]
set_output_delay -clock [get_clocks PHI2] -min 10 [get_ports DATA]
...
#set_output_delay -clock [get_clocks PHI2] -max 20 [get_ports PHI2]
#set_output_delay -clock [get_clocks PHI2] -min 10 [get_ports PHI2]
...
set_output_delay -clock [get_clocks PHI2] -max 20 [get_ports RESB]
set_output_delay -clock [get_clocks PHI2] -min 10 [get_ports RESB]

set_property PACKAGE_PIN M1 [get_ports SYNC]
set_property IOSTANDARD LVCMOS33 [get_ports SYNC]
set_input_delay -clock [get_clocks PHI2] -max 20 [get_ports SYNC]
set_input_delay -clock [get_clocks PHI2] -min 10 [get_ports SYNC]

set_property PACKAGE_PIN M2 [get_ports RWB]
set_property IOSTANDARD LVCMOS33 [get_ports RWB]
set_input_delay -clock [get_clocks PHI2] -max 20 [get_ports RWB]
set_input_delay -clock [get_clocks PHI2] -min 10 [get_ports RWB]

set_property PACKAGE_PIN M3 [get_ports RDY]
set_property IOSTANDARD LVCMOS33 [get_ports RDY]
set_output_delay -clock [get_clocks PHI2] -max 20 [get_ports RDY]
set_output_delay -clock [get_clocks PHI2] -min 10 [get_ports RDY]

# Processor interrupt controls
set_property PACKAGE_PIN L3 [get_ports IRQB]
set_property IOSTANDARD LVCMOS33 [get_ports IRQB]
set_output_delay -clock [get_clocks PHI2] -max 20 [get_ports IRQB]
set_output_delay -clock [get_clocks PHI2] -min 10 [get_ports IRQB]

set_property PACKAGE_PIN K3 [get_ports NMIB]
set_property IOSTANDARD LVCMOS33 [get_ports NMIB]
set_output_delay -clock [get_clocks PHI2] -max 20 [get_ports NMIB]
set_output_delay -clock [get_clocks PHI2] -min 10 [get_ports NMIB]

# Set to center directional button on board
set_property PACKAGE_PIN U18 [get_ports Reset]
set_property IOSTANDARD LVCMOS33 [get_ports Reset]
set_input_delay -clock [get_clocks PHI2] -max 20 [get_ports Reset]
set_input_delay -clock [get_clocks PHI2] -min 10 [get_ports Reset]
...
set_input_delay -clock [get_clocks PHI2] -max 20 [get_ports SingleStep]
set_input_delay -clock [get_clocks PHI2] -min 10 [get_ports SingleStep]
...
set_output_delay -clock [get_clocks PHI2] -max 20 [get_ports LED_OUT]
set_output_delay -clock [get_clocks PHI2] -min 10 [get_ports LED_OUT]
...
set_output_delay -clock [get_clocks PHI2] -max 20 [get_ports PIO_7SEG_COMMON]
set_output_delay -clock [get_clocks PHI2] -min 10 [get_ports PIO_7SEG_COMMON]
...
set_output_delay -clock [get_clocks PHI2] -max 20 [get_ports PIO_7SEG_SEGMENTS]
set_output_delay -clock [get_clocks PHI2] -min 10 [get_ports PIO_7SEG_SEGMENTS]
