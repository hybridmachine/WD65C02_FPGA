...
#                script (type 'T_MEMORY_MANAGER.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.T_MEMORY_MANAGER -o T_MEMORY_MANAGER_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./T_MEMORY_MANAGER_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key T_MEMORY_MANAGER_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc T_MEMORY_MANAGER_simv.daidir vcs_lib c.obj)
