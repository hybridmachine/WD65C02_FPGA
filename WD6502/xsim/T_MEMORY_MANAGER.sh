...
#
# Script generated by Vivado on Sat Oct 14 14:05:13 -0500 2023
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : T_MEMORY_MANAGER.sh
...
#
# Usage        : T_MEMORY_MANAGER.sh
#                T_MEMORY_MANAGER.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                T_MEMORY_MANAGER.sh [-reset_run]
#                T_MEMORY_MANAGER.sh [-reset_log]
#                T_MEMORY_MANAGER.sh [-help]
#
...
# script info
echo -e "T_MEMORY_MANAGER.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./T_MEMORY_MANAGER.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L secureip --snapshot T_MEMORY_MANAGER xil_defaultlib.T_MEMORY_MANAGER -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim T_MEMORY_MANAGER -key {Behavioral:Test_Component_MemoryManager:Functional:T_MEMORY_MANAGER} -tclbatch cmd.tcl -protoinst "protoinst_files/design_with_logic_probe.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb T_MEMORY_MANAGER.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./T_MEMORY_MANAGER.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: T_MEMORY_MANAGER.sh [-help]\n\
Usage: T_MEMORY_MANAGER.sh [-step]\n\
Usage: T_MEMORY_MANAGER.sh [-lib_map_path]\n\
Usage: T_MEMORY_MANAGER.sh [-reset_run]\n\
Usage: T_MEMORY_MANAGER.sh [-reset_log]\n\
Usage: T_MEMORY_MANAGER.sh [-keep_index]\n\
Usage: T_MEMORY_MANAGER.sh [-noclean_files]\n\n\
