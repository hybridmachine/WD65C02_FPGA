...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.T_MEMORY_MANAGER
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.T_MEMORY_MANAGER -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log T_MEMORY_MANAGER_sc.so .tmp_log xcelium_lib waves.shm c.obj)
