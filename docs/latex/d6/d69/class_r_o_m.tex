...
Contains the executable that will run when the 65C02 boots.  


Inheritance diagram for ROM\+:\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[height=5.283019cm]{d6/d69/class_r_o_m}
\end{center}
\end{figure}
...
\begin{DoxyCompactList}\small\item\em Address to be read. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Memory clock (typically just FPGA clock) \end{DoxyCompactList}\item 
...
Brian Tabone
\end{DoxyAuthor}
This \mbox{\hyperlink{class_r_o_m}{ROM}} file contains the executable that will run when the 65C02 boots. To load it use the Intel HEX to \mbox{\hyperlink{class_r_o_m}{ROM}} converter ASM\textbackslash{}\+Hex\+To\+VHDLTools\textbackslash{}\+Convert\+Hex\+To\+VHD\+\_\+\+ROM.\+py . See an example of its usage in ASM\textbackslash{}\+Sieve\+Of\+Eratosthenes\textbackslash{}make.\+bat 
